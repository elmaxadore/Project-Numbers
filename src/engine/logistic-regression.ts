 ...
 */
export async function saveModelToFile(model: ModelWeights, filePath: string): Promise<void> {
 ...
 */
export async function loadModelFromFile(filePath: string): Promise<ModelWeights> {
  const fs = await import('fs');
