...
function loadHistoricalData() {
    ...
    if (rawData.data && Array.isArray(rawData.data)) {
        ...
        footballMatches = rawData.filter((m) => m.sport === 'football' || m.league);
    }
    ...
    const seasonOrder = { '2021-22': 1, '2022-23': 2, '2023-24': 3 };
    matches.sort((a, b) => {
 ...
 */
function predictOver25(match, historicalStats) {
...
function predictBTTS(match, historicalStats) {
    // Base probability from training data historical average
 ...
 */
export function printRealBacktestResults(results) {
    console.log('\n╔══════════════════════════════════════════════════════╗');
...
export { main };
//# sourceMappingURL=real-backtest.js.map