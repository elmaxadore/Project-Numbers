 ...
 */
export async function getFixturesByDate(startDate, endDate) {
...
async function fetchFootballDataFixtures(startDate, endDate) {
    const fixtures = [];
...
async function fetchTheSportsDBFixtures(startDate, endDate) {
    const fixtures = [];
    const apiKey = '123';
